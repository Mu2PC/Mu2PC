...
from fairseq.models.wav2vec.wav2vec2 import LAYER_TYPE_CHOICES
...
class AVHubertModel(BaseFairseqModel):
    def __init__(
        ...
        **kwargs
        ...
        # Wrapper
        self.label_embs_concat = nn.Parameter(torch.FloatTensor(2004, final_dim))
    ...
    def build_model(cls, cfg: AVHubertConfig, task: AVHubertPretrainingTask):
        ...
        kwargs = {}
        model = AVHubertModel(cfg, task.cfg, **kwargs)
        return model
