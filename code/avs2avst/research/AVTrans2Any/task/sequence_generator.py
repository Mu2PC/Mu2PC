...
class SequenceGenerator(nn.Module):
    ...
    def _generate(
        ...
        finalized = self.generate_decoder(
            encoder_outs,
            src_tokens['audio'] if 'audio' in src_tokens and src_tokens['audio'] != None else src_tokens['video'],
            src_lengths,
            sample,
            prefix_tokens,
            constraints,
    ...
    def generate_decoder(
        ...
        bsz, src_len = src_tokens.size()[0], src_tokens.size()[2] # [B, 104, 155] or [B, 1, 155, 88, 88]
