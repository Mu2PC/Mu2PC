...
def wav2lip_one_video(pair):
	...
	outfile_name = "/".join(face_in.rsplit('/', 3)[-3:])
...
def main():
	...
	for clip_id in wav2lip_id:
		face_path = os.path.join(video_root, clip_id, "00.avi")
		wav_file = "_".join([clip_id.rsplit('_', 2)[0], clip_id.rsplit('_', 1)[-1]]) + ".wav"
		wav_path = os.path.join(tts_root, wav_file)
...
if __name__ == '__main__':
	...
	video_root = f"/root/autodl-tmp/data/mtedx/video_clip/{src_lang}"
